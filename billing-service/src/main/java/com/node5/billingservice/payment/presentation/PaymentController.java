...
public class PaymentController {
    ...
    @GetMapping("/{memberId}")
    public ResponseEntity<Page<PaymentInfo>> findAll(@PathVariable UUID memberId, Pageable pageable) {
    ...
    public ResponseEntity<PaymentInfo> request(@PathVariable UUID memberId, @RequestBody PaymentRequest request) {
    ...
    public ResponseEntity<PaymentInfo> confirm(@PathVariable UUID memberId, @RequestBody PaymentConfirmRequest request) {
    ...
    @PostMapping("/{memberId}/failure")
    public ResponseEntity<PaymentFailureInfo> failure(@PathVariable UUID memberId, @RequestBody PaymentFailureRequest request) {
    ...
    public ResponseEntity<PaymentInfo> cancel(@PathVariable UUID memberId, @RequestBody PaymentCancelRequest request) {
