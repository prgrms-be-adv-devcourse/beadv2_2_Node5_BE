...
public class WalletController {
    ...
    @GetMapping("{memberId}")
    public ApiResponseDto<WalletInfo> getWallet(@PathVariable UUID memberId) {
        return walletService.getWallet(memberId);
    }

    @Operation(summary = "예치금 생성", description = "회원의 예치금 계좌를 생성한다.")
    @PostMapping("{memberId}")
    public ApiResponseDto<WalletInfo> createWallet(@PathVariable UUID memberId) {
    ...
    public PagedResponseDto<WalletDepositInfo> getDepositLogs(@PathVariable UUID memberId, Pageable pageable) {
    ...
    public PagedResponseDto<WalletWithdrawInfo> getWithdraws(@PathVariable UUID memberId, Pageable pageable) {
    ...
    public ApiResponseDto<WalletInfo> charge(@PathVariable UUID memberId, @RequestBody WalletChargeRequest request) {
    ...
    public ApiResponseDto<WalletInfo> settle(@PathVariable UUID memberId, @RequestBody WalletSettleRequest request) {
    ...
    public ApiResponseDto<WalletInfo> withdraw(@PathVariable UUID memberId, @RequestBody WalletWithdrawRequest request) {
    ...
    public ApiResponseDto<WalletInfo> requestRefund(@PathVariable UUID memberId, @RequestBody WalletRefundRequest request) {
    ...
    public ApiResponseDto<WalletInfo> successRefund(@PathVariable UUID memberId, @RequestBody WalletRefundRequest request) {
    ...
    public ApiResponseDto<WalletInfo> failRefund(@PathVariable UUID memberId, @RequestBody WalletRefundRequest request) {
